...
public class Main {
    ...
    static int tabuIterationsLimit = 1000;
    static int tabuNoNeighbours = 1000;
    static int tabuNeighbourhoodSize = 10;
    static int tabuListMaxSize = 10;

    static Double temperatureSA = 5000000.0;
    ...
    private static Population sa(Population population, Double[][] matrix) throws IOException {
...
//        return temp - x / y;
    ...
    private static Population tabu(Population population, Double[][] matrix) throws FileNotFoundException {
        calculateIndividualsFitness(population, matrix);
        Individual best = population.getBestIndividual();
    ...
    public static void GAconf(Population population, Double[][] matrix) throws IOException {
                        ...
                        for (double crossoverRate : crossoverRates) {
                            for (double mutationRate : mutationRates) {
                                for (int amountOfChamps : amountsOfChamps) {
                                    ...
                                    population = Population.generateNewRandomPopulation(populationSize, matrix.length);
                                    calculateIndividualsFitness(population, matrix);
